...
export default {
  'code-http': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode1},"rapper/http/index.ts":{"import":"../rapper/http","content":rawCode2},"rapper/http/http.ts":{"import":"./http","content":rawCode3},"rapper/http/pos.ts":{"import":"./pos","content":rawCode4},"rapper/http/models.ts":{"import":"./models","content":rawCode5}},"dependencies":{"antd":{"version":"4.24.4","css":"antd/dist/antd.css"},"react":{"version":">=16.9.0"},"react-dom":{"version":">=16.9.0"},"@rapper3/request":{"version":"0.1.0"}},"identifier":"code-http"},
  },
  'code-reacthooks': {
    component: dynamic({
  ...
  'reactquery-reactquery': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode12},"utils.ts":{"import":"./utils","content":rawCode13},"rapper/http/index.ts":{"import":"../rapper/http","content":rawCode2},"rapper/http/http.ts":{"import":"./http","content":rawCode3},"rapper/http/pos.ts":{"import":"./pos","content":rawCode4},"rapper/http/models.ts":{"import":"./models","content":rawCode5}},"dependencies":{"antd":{"version":"4.24.4","css":"antd/dist/antd.css"},"react":{"version":"^16.8.0 || ^17.0.0 || ^18.0.0"},"@tanstack/react-query":{"version":"^4"},"react-dom":{"version":"^16.8.0 || ^17.0.0 || ^18.0.0"},"react-native":{"version":"*"},"@rapper3/react-query":{"version":"0.2.0"},"@rapper3/request":{"version":"0.1.0"}},"identifier":"reactquery-reactquery"},
  },
  ...
  'reactquery-usemutation': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode15},"utils.ts":{"import":"./utils","content":rawCode13},"rapper/http/index.ts":{"import":"../rapper/http","content":rawCode2},"rapper/http/http.ts":{"import":"./http","content":rawCode3},"rapper/http/pos.ts":{"import":"./pos","content":rawCode4},"rapper/http/models.ts":{"import":"./models","content":rawCode5}},"dependencies":{"antd":{"version":"4.24.4","css":"antd/dist/antd.css"},"react":{"version":"^16.8.0 || ^17.0.0 || ^18.0.0"},"@tanstack/react-query":{"version":"^4"},"react-dom":{"version":"^16.8.0 || ^17.0.0 || ^18.0.0"},"react-native":{"version":"*"},"@rapper3/react-query":{"version":"0.2.0"},"@rapper3/request":{"version":"0.1.0"}},"identifier":"reactquery-usemutation"},
  },
  ...
  'code-reactswr': {
    ...
    previewerProps: {"sources":{"_":{"tsx":rawCode17},"rapper/http/index.ts":{"import":"../rapper/http","content":rawCode2},"rapper/http/http.ts":{"import":"./http","content":rawCode3},"rapper/http/pos.ts":{"import":"./pos","content":rawCode4},"rapper/http/models.ts":{"import":"./models","content":rawCode5}},"dependencies":{"antd":{"version":"4.24.4","css":"antd/dist/antd.css"},"@rapper3/react-swr":{"version":"0.1.0"},"react":{"version":">=16.9.0"},"react-dom":{"version":">=16.9.0"},"@rapper/request":{"version":"^0.0.3"},"swr":{"version":"^1.3.0"},"@rapper3/request":{"version":"0.1.0"}},"identifier":"code-reactswr"},
  },
};
