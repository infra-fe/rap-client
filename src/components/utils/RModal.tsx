...
class RModal extends Component<any, any> {
  ...
  static reposition($rmodal: any) {
    ...
    const left =
            (document.documentElement.clientWidth - $rmodal.clientWidth) / 2
    const top =
            (document.documentElement.clientHeight - $rmodal.clientHeight) / 2
