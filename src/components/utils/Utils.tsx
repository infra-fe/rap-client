...
export default () => (
  <section className="Utils">
    <ul>
      <li>
        <Link to="/utils/popover">Popover</Link>
      </li>
      <li>
        <Link to="/utils/spin">Spin</Link>
      </li>
      <li>
        <Link to="/utils/smarttextarea">SmartTextarea</Link>
      </li>
      <li>
        <Link to="/utils/tagsinput">TagsInput</Link>
      </li>
      <li>
        <Link to="/utils/property/editor">PropertyEditor</Link>
      </li>
      <li>
        <Link to="/utils/property/modal">Modal</Link>
      </li>
      <li>
        <Link to="/utils/property/rsortable">Modal</Link>
      </li>
    </ul>
    <Switch>
      ...
      <Route
        path="/utils/smarttextarea"
        component={SmartTextareaExample}
      />
