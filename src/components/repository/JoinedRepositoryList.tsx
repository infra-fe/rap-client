...
const mapStateToProps = (state: RootState) => ({
  ...
  repositories: {
    fetching:
            state.ownedRepositories.fetching ||
            state.joinedRepositories.fetching,
    data: _.uniqBy(
      [...state.ownedRepositories.data, ...state.joinedRepositories.data],
      'id'
    ).sort((a, b) => {
